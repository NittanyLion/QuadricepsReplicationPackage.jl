...
See [`replicate`](@ref), [`check_cell`](@ref), [`check_extended`](@ref), [`verify_rule`](@ref)
...
export replicate, replicated, check_cell, check_extended, verify_rule, moller_bound, pair_floor, rho,
